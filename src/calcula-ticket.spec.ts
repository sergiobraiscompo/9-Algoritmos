...
import { LineaTicket, ResultadoLineaTicket, ResultadoTotalTicket } from "./ticket-constantes";

describe('creaResultadoLineaTicket', () => {    
    it.each([
        [{producto: {nombre: "Legumbres", precio: 2, tipoIva: "general"}, cantidad: 2}, {nombre: "Legumbres", cantidad: 2, precioSinIva: 2, tipoIva: "general", precioConIva: 2.42}],
        [{producto: {nombre: "Perfume", precio: 20, tipoIva: "general"}, cantidad: 3}, {nombre: "Perfume", cantidad: 3, precioSinIva: 20, tipoIva: "general", precioConIva: 24.2}],
        [{producto: {nombre: "Leche", precio: 1, tipoIva: "superreducidoC"}, cantidad: 6}, {nombre: "Leche", cantidad: 6, precioSinIva: 1, tipoIva: "superreducidoC", precioConIva: 1}],
        [{producto: {nombre: "Lasaña", precio: 5, tipoIva: "superreducidoA"}, cantidad: 1}, {nombre: "Lasaña", cantidad: 1, precioSinIva: 5, tipoIva: "superreducidoA", precioConIva: 5.25}]
    ]) ("Si el producto es %s, la línea completa del ticket ha de ser %s", (lineaTicket: LineaTicket, resultadoEsperado) => {
        // Act
